...
$routes->group('', ['filter' => 'auth'], static function ($routes) {
    ...
    $routes->group('', ['filter' => 'admin:1'], static function ($routes) {
        $routes->get('reportes/participantes-curso/(:num)', 'ReporteCursoController::detalleCurso/$1');
        $routes->post('reportes/cambiar-estado-participante', 'ReporteCursoController::cambiarEstadoParticipante');
        $routes->get('reportes/exportar-excel/(:num)', 'ReporteCursoController::exportarExcel/$1');
