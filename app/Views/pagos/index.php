                    ...
                    <form method="get" class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="metodo_pago" class="form-select">
                                <option value="">-- Todos --</option>
                                <option value="banco_nacion" <?= (isset($filtros['metodo_pago']) && $filtros['metodo_pago']=='banco_nacion')?'selected':'' ?>>Banco de la Nación</option>
                                ...
                                <?php else: ?>
                                    <?php foreach ($pagos as $p): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <small class="text-primary fw-medium"><?= esc($p['curso_nombre'] ?? 'N/A') ?></small>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <span class="fw-bold text-success">S/ <?= number_format($p['monto'], 2) ?></span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    <?php if ($p['estado'] !== 'aprobado'): ?>
                                                        <form action="<?= base_url('pagos/aprobar/' . $p['id']) ?>" method="post" class="d-inline">
                                                            <?= csrf_field() ?>
            ...
            <form id="rejectForm" method="post">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <strong>Atención:</strong> Esta acción rechazará el comprobante y enviará una notificación al participante.
                    </div>
                    <div class="mb-3">
